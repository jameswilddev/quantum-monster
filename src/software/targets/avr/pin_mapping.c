...
extern void qm_target_avr_pin_mapping_initialize()
{
  ...
  INPUT_WITH_INTERNAL_PULL_UP(QM_TARGET_AVR_PIN_MAPPING_A_BUTTON);
  INPUT_WITH_INTERNAL_PULL_UP(QM_TARGET_AVR_PIN_MAPPING_B_BUTTON);
  INPUT_WITH_INTERNAL_PULL_UP(QM_TARGET_AVR_PIN_MAPPING_C_BUTTON);
  INPUT_WITH_INTERNAL_PULL_UP(QM_TARGET_AVR_PIN_MAPPING_INFRARED_RECEIVER_OUT);
